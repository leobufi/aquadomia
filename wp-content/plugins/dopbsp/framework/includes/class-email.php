 ...
 */
    ...
    if (!class_exists('DOTEmail')){
	     ...
	     * 
	     * @functions
	     *	    This function includes directly the PHPMailer API files
	     *	    [framework/libraries/phpmailer/src/PHPMailer.php] &
		 *      [framework/libraries/phpmailer/src/POP3.php] &
		 *      [framework/libraries/phpmailer/src/SMTP.php] &
		 *      [framework/libraries/phpmailer/src/OAuth.php] &
		 *      [framework/libraries/phpmailer/src/Exception.php]
         *
	    ...
	    function smtp($subject = '',
			  ...
			  $email_bcc = '',
			  $email_bcc_name = ''){
		include_once('framework/libraries/phpmailer/src/class.phpmailer.php');
		include_once('framework/libraries/phpmailer/src/POP3.php');
		include_once('framework/libraries/phpmailer/src/class.smtp.php');
