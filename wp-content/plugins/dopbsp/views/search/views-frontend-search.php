...
// HOOK (dopbsp_action_frontend_search_content_before) ****************************** Add content before calendar.
                ...
                $template = $this->getTemplate($settings_search->template);
                
                /*
                 * Search HTML.
                 */
                array_push($html, '<link rel="stylesheet" type="text/css" href="'.$template.'" />');
...
// HOOK (dopbsp_action_frontend_search_content_before) ****************************** Add content before calendar.
                ...
                $template = $this->getTemplateWidget($settings_search->template);
...
// HOOK (dopbsp_frontend_content_after_calendar) ******************************* Add content after calendar.
             ...
             * Get search template.
             *
             * @param setting (integer): template setting
             *
             * @return template path
             */
            function getTemplate($setting){
                global $DOPBSP;
                 ...
                 */
                $template = $DOPBSP->paths->url.'templates/'.$template_name.'/css/jquery.dop.frontend.BSPSearch.css';
                $template_custom = content_url().'/dopbsp-templates/'.$template_name.'/css/jquery.dop.frontend.BSPSearch.css';
                $template_custom_path = WP_CONTENT_DIR.'/dopbsp-templates/'.$template_name.'/css/jquery.dop.frontend.BSPSearch.css';
            ...
            /*
             * Get search widget template.
             *
             * @param setting (integer): template setting
             *
             * @return template path
             */
            function getTemplateWidget($setting){
                global $DOPBSP;
                 ...
                 * Set custom template path.
                 */
                $template = $DOPBSP->paths->url.'templates/'.$template_name.'/css/jquery.dop.frontend.BSPSearchWidget.css';
                $template_custom = content_url().'/dopbsp-templates/'.$template_name.'/css/jquery.dop.frontend.BSPSearchWidget.css';
                $template_custom_path = WP_CONTENT_DIR.'/dopbsp-templates/'.$template_name.'/css/jquery.dop.frontend.BSPSearchWidget.css';
