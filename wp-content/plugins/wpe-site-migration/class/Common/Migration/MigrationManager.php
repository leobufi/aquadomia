...
class MigrationManager {
	...
	private $retry_errors = [
		...
		'curl_error_56'                   => 'cURL error 56: Recv failure: Connection reset by peer',
		'unable_to_connect_520'           => 'Unable to connect to the remote server, please check the connection details - 520',
	...
	protected function handle_error( $error, $stage ) {
		...
		$retry_errors = array_filter( $this->retry_errors, function ( $item ) use ( $error_message ) {
