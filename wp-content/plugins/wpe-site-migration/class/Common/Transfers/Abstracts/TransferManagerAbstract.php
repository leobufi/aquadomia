...
abstract class TransferManagerAbstract {
	...
	const STABILIZE_TIMEOUT     = MINUTE_IN_SECONDS * 1;
	...
	public function filter_process_stage( $progress, $stage, $migration_id ) {
		if (
			! in_array(
				$stage,
				[ Stage::MEDIA_FILES, Stage::THEME_FILES, Stage::PLUGIN_FILES, Stage::OTHER_FILES, Stage::MUPLUGIN_FILES, Stage::CORE_FILES, Stage::ROOT_FILES ]
			)
		) {
			return $progress;
		}
