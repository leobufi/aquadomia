((e) => {
  (ASTControlTrigger = {
    triggerHook: function (t, s) {
      e("body").trigger("astra-control-trigger." + t, s);
    },
    addHook: function (t, s) {
      e("body").on("astra-control-trigger." + t, s);
    },
    removeHook: function (t, s) {
      e("body").off("astra-control-trigger." + t, s);
    },
  }),
