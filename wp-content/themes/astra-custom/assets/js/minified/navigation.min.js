  ...
  (() => {
      ...
      var e,
        ...
        i =
          ...
          (AstraToggleMenu = function (e) {
            if (
              ...
              for (var t = 0; t < e.length; t++)
                e[t].removeEventListener("click", AstraToggleSubMenu),
            ...
            if (0 < r.length)
              for (var t, a = 0; a < r.length; a++)
                if (
                  ...
                  o[a] ||
                    ((o[a] = r[a]),
                    r[a].removeEventListener("click", astraNavMenuToggle),
                  ...
                  if (
                    ...
                    for (var n = 0; n < t.length; n++)
                      t[n].removeEventListener("click", AstraToggleSubMenu),
          ...
          /trident/i.test(t[1])
            ? (v = /\brv[ :]+(\d+)/g.exec(e) || [])
            : ("Chrome" === t[1] &&
                null != (v = e.match(/\bOPR|Edge\/(\d+)/))) ||
              ((t = t[2]
                ? [t[1], t[2]]
                : [navigator.appName, navigator.appVersion, "-?"]),
              null != (v = e.match(/version\/(\d+)/i)) && t.splice(1, 1, v[1]),
              (e = document.body),
              "Safari" === t[0] &&
                t[1] < 11 &&
                e.classList.add("ast-safari-browser-less-than-11")),
    ...
    function d() {
      ...
      if (
        ...
        if (
          ...
          var t = document.querySelector(".main-header-bar-navigation"),
            t =
              (t.classList.remove("toggle-on"),
              (t.style.display = "none"),
              document.querySelector(".menu-below-header-toggle")),
    ...
    if (
      ...
      "querySelector" in document &&
        ...
        ((a = document.body).addEventListener("mousedown", function () {
      ...
      if (v)
        for (var f of v)
          f.href.split("#")[0] !== location.href.split("#")[0]
            ...
            : "" !== f.hash && f.addEventListener("click", h);
    ...
    astra.is_scroll_to_top &&
      ...
      (s = document.getElementById("ast-scroll-top")),
