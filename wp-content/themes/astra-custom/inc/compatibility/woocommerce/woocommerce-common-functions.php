    ...
    if ( apply_filters( 'astra_woo_shop_parent_category', true ) ) : ?>
        <span class="ast-woo-product-category">
            ...
            if ( $product_categories ) {
                ...
                $category = get_term_by( 'name', $parent_cat, 'product_cat' );
...
if ( ! function_exists( 'astra_woo_woocommerce_shop_product_content' ) ) {
    ...
    $duree_formation = get_post_meta( $product->get_id(), 'duree_formation', true );
      ...
      foreach ( $shop_structure as $value ) {
        switch ($value) {
            ...
            if (! empty($product->get_price())) {
              echo '<div class="astra-woo-price-card-container">';
      ...
      if ( ! empty( $duree_formation ) ) {
        ...
        echo '<div class="astra-woo-summary-left">';
        echo '<span class="duration">' . esc_html( $duree_formation ) . '</span>';
        echo '</div>';
        echo '<div class="astra-woo-summary-right">';
      } else {
        echo '<div class="astra-shop-summary-wrap no-grid">';
        echo '<div class="astra-woo-summary">';
      }
      ...
      if ( $product_title_link ) {
        echo'<div class="ast-product-link_bottom_wrap">';
        if (! empty($product->get_price())) {
        echo '<a href="' . esc_url( get_the_permalink() ) . '" class="ast-product-link_bottom">Réserver</a>';
        } else {
          echo '<a href="' . esc_url( get_the_permalink() ) . '" class="ast-product-link_bottom">En savoir plus</a>';
        }
        echo '</div>';
      }
			echo '</div>';
